...
<? include $_SERVER["DOCUMENT_ROOT"]."/inc/head.php" ?>
    ...
    <meta name="description" content="GTA 인생모드(FiveM) 제우스 서버 플레이를 하면서 궁금한 점을 물어보고 답변을 받아보세요." />
	<meta property="og:description" content="GTA 인생모드(FiveM) 제우스 서버 플레이를 하면서 궁금한 점을 물어보고 답변을 받아보세요." />
	<meta property="og:title" content="Premium RPG ZEUS - <?=$bbs?>" />
    <link rel="canonical" href="https://zeusrpg.kr/community/qnaboard" />
    <meta property="og:url" content="https://zeusrpg.kr/community/qnaboard" />
</head>
...
<div class="container my-5 table-responsive">
    ...
    <ul class="nav nav-tabs mb-5">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="qnaboard">질문 게시판</a>
        </li>
    </ul>
