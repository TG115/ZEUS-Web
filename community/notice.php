...
<? include $_SERVER["DOCUMENT_ROOT"]."/inc/head.php" ?>
    ...
    <meta name="description" content="GTA 인생모드(FiveM) 제우스 서버의 공지사항을 확인할 수 있는 공간입니다." />
	<meta property="og:description" content="GTA 인생모드(FiveM) 제우스 서버의 공지사항을 확인할 수 있는 공간입니다." />
	<meta property="og:title" content="Premium RPG ZEUS - <?=$bbs?>" />
    <link rel="canonical" href="https://zeusrpg.kr/community/notice" />
    <meta property="og:url" content="https://zeusrpg.kr/community/notice" />
</head>
...
<div class="container my-5 table-responsive">
    ...
    <ul class="nav nav-tabs mb-5">
        <li class="nav-item">
            <a class="nav-link active" href="notice">공지사항</a>
        </li>
        <li class="nav-item">
