...
<? include $_SERVER["DOCUMENT_ROOT"]."/inc/head.php" ?>
    ...
    <meta name="description" content="GTA 인생모드(FiveM) 제우스 서버를 플레이 하며 얻은 나만의 꿀팁을 서로 공유하는 공간입니다." />
	<meta property="og:description" content="GTA 인생모드(FiveM) 제우스 서버를 플레이 하며 얻은 나만의 꿀팁을 서로 공유하는 공간입니다." />
	<meta property="og:title" content="Premium RPG ZEUS - <?=$bbs?>" />
    <link rel="canonical" href="https://zeusrpg.kr/community/tipboard" />
    <meta property="og:url" content="https://zeusrpg.kr/community/tipboard" />
</head>
...
<div class="container my-5 table-responsive">
    ...
    <ul class="nav nav-tabs mb-5">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="tipboard">꿀팁 게시판</a>
        </li>
        <li class="nav-item">
