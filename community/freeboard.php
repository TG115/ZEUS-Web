...
<? include $_SERVER["DOCUMENT_ROOT"]."/inc/head.php" ?>
    ...
    <meta name="description" content="GTA 인생모드(FiveM) 제우스 서버를 플레이하는 유저들끼리 서로 소통해볼 수 있는 공간입니다." />
	<meta property="og:description" content="GTA 인생모드(FiveM) 제우스 서버를 플레이하는 유저들끼리 서로 소통해볼 수 있는 공간입니다." />
	<meta property="og:title" content="Premium RPG ZEUS - <?=$bbs?>" />
    <link rel="canonical" href="https://zeusrpg.kr/community/freeboard" />
    <meta property="og:url" content="https://zeusrpg.kr/community/freeboard" />
</head>
...
<div class="container my-5 table-responsive">
    ...
    <ul class="nav nav-tabs mb-5">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="freeboard">자유 게시판</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="eventboard">이벤트 게시판</a>
        </li>
        <li class="nav-item">
    ...
    <table class="table shadow border-bottom text-center table-hover">
