...
<? if (isset($_SESSION['zeus_id'])) { echo "<script>location.href='/';</script>"; } ?>
  <title>Premium RPG ZEUS - 비밀번호 찾기</title>
</head>
              ...
              <form role="form" action="findinfo.proc.php" method="post">
                ...
                <span class="form-text h6 fw-bold text-light">아이디<span class="text-danger">*</span></span>
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" name="f_id" placeholder="아이디" type="text" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="text-center">
                  ...
                  <button type="submit" class="btn btn-primary my-4">비밀번호 찾기</button>
                </div>
                <div class="text-center">
                  <a href="/login" class="text-white-50">로그인</a> | <a href="/findID" class="text-white-50">아이디 찾기</a> 
                </div>
              </form>
            </div>
          </div>
